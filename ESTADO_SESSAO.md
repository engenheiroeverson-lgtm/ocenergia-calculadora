...
> Última atualização: 2026-06-24 (grafias ANEEL auto-publicáveis)
...
- **Pipeline de sync (NÃO MEXER — está correto):**
  ...
  - Sync semanal agora pode disparar a esteira normalmente: commit do robô não usa mais `[skip ci]`.
---
